Gem::Specification.new do |s|
  ...
  s.files = %w( BOAST.gemspec LICENSE lib/BOAST.rb lib/BOAST/Algorithm.rb lib/BOAST/CKernel.rb lib/BOAST/BOAST_OpenCL.rb lib/BOAST/Transitions.rb lib/BOAST/Parens.rb lib/BOAST/Operators.rb lib/BOAST/DataTypes.rb lib/BOAST/Arithmetic.rb lib/BOAST/Expression.rb lib/BOAST/Index.rb lib/BOAST/Variable.rb lib/BOAST/Procedure.rb )
  s.has_rdoc = true
  s.license = 'BSD'
