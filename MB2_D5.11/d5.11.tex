...
source side, if applicable. Finally, a control flow graph (also as a \verb|.dot| 
file) is generated to display the memory reference computation flows and data 
computation flows, to give a visual insight of the control flow dependence edges 
found by MAQAO in the binary kernel.
